...
const MainContent = () => {
  ...
  const [newPopupOpen, setNewPopupOpen] = useState(false); // State for new popup
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Box sx={{ textAlign: { xs: 'center', md: 'left' }, mb: { xs: 4, md: 0 }, flex: 1, px: { xs: 2, md: 4 } }}>
            ...
            <Box component="ul" sx={{ listStyle: 'none', pl: 0, fontFamily: 'Poppins', fontSize: { xs: '14px', sm: '18px', md: '20px' }, color: 'white', mb: 4, lineHeight: 1.5 }}>
              <GreenTickListItem>
